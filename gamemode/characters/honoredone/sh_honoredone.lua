...
K.Character( "honoredone", {
	...
	abilities = {
		...
		-- TODO "Air Blink" on an airborne target: a kick then the red (17.5).
	...
	awakening = {
		...
		-- TODO awakening variant "0.2 Domain": special during the sequence expands Infinite Void for 0.2s (double range,
		-- half duration) then a 3 phase rush (35 + 120 + 65).
		abilities = {
			-- A controllable blue vortex that pulls in and harms everything near it for 20 ticks (2.2 per tick).
			-- TODO variant "Unlimited Purple": shooting Max Blue's finisher with Max Red (50-100 by distance).
